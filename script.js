...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-05-15T17:01:17.194Z',
    '2024-05-16T23:36:17.929Z',
...
const dateFormatter = function (dateObject, locale) {
  ...
  return Intl.DateTimeFormat(locale).format(dateObject);
};
const displayMovements = function (
  ...
  movs.forEach(function (mov, i) {
    ...
    const movementDate = dateFormatter(new Date(movementsDates[i]), locale);
...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    ...
    // Doing the transfer and adding movement's dates
